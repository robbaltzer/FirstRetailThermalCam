...
@interface RBTMasterViewController () {
...
- (void)viewDidLoad
{
	...
	self.detailViewController = (RBTDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
